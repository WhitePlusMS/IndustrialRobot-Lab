        ...
        <>
          ...
          <div className="space-y-0.5 font-mono text-xs">
            <div className="flex justify-between">
              ...
              <span className="text-[#0F172A]">{position[0].toFixed(2)} mm</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#64748B]">Y:</span>
              <span className="text-[#0F172A]">{position[1].toFixed(2)} mm</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#64748B]">Z:</span>
              <span className="text-[#0F172A]">{position[2].toFixed(2)} mm</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#64748B]">Rx:</span>
              <span className="text-[#0F172A]">{euler[0].toFixed(1)}°</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#64748B]">Ry:</span>
              <span className="text-[#0F172A]">{euler[1].toFixed(1)}°</span>
            </div>
            <div className="flex justify-between">
              <span className="text-[#64748B]">Rz:</span>
              <span className="text-[#0F172A]">{euler[2].toFixed(1)}°</span>
            </div>
          </div>
        </>
      )}
        ...
        <div className="grid grid-cols-2 gap-x-3 gap-y-0.5 font-mono text-xs">
          {joints.map((angle, i) => (
            <div key={i} className="flex justify-between">
              ...
              <span className="text-[#0F172A]">{angle.toFixed(1)}°</span>
            </div>
          ))}
        </div>
      )}
