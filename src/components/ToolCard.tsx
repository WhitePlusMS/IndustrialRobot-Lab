      ...
      {!collapsed && (
        <div className="p-3 space-y-2">
          <div className="flex items-center gap-2">
            <Wrench className="w-3.5 h-3.5 text-[#64748B] shrink-0" />
            <select
              value={selectedTool}
              onChange={(e) => onToolChange(e.target.value)}
              className="flex-1 px-2 py-1.5 text-xs border border-[#D1D5DB] rounded-sm bg-[#FAFAFA] focus:outline-none focus:border-[#2563EB] cursor-pointer"
            >
