    ...
    <div className="bg-white rounded-md border border-[#E5E7EB] overflow-hidden">
      ...
      <div className="p-3 space-y-2.5">
        <div className="flex items-center gap-2">
          <span className="text-[11px] text-[#64748B] w-8">数量</span>
          <input
            type="number"
            value={count}
        ...
        <div className="flex items-center gap-2">
          <span className="text-[11px] text-[#64748B] w-8">尺寸</span>
          <input
            type="range"
            value={size}
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 py-1.5 text-xs font-medium text-white bg-[#2563EB] rounded-sm hover:bg-[#1D4ED8] transition-colors"
          >
          ...
          <button
            onClick={onClear}
            disabled={!hasParts}
            className="flex items-center justify-center gap-1 py-1.5 px-3 text-xs font-medium text-[#64748B] bg-[#F1F5F9] border border-[#D1D5DB] rounded-sm hover:bg-[#E2E8F0] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
